...
public class CategoriesDAO {
  ...
  private static Category cursorToCategory(Cursor cursor) {
	...
	public static Category[] getCategoriesForTransaction(SQLiteDatabase db, long transactionID) {
		
		Cursor c = db.rawQuery("SELECT C.categoryID, C.userID, C.category_name " +
	 ...
	 */
	public static Category addCategoryForDB(SQLiteDatabase db, long userID, String categoryName) {
