...
public class AddUserActivity extends Activity {
        ...
        buttonLogin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!userExists && validUsername && validPassword && validEmail) {
                    ...
                    // Adds a default category at user creation to avoid
                    // breaking
     ...
     * 
     * @param username
     *            the username string that the user input into the system.
     * 
     ...
     * 
     * @param pass
     *            the password string that the user input into the system.
     * 
     ...
     * 
     * @param email
     *            the email string that the user input into the system.
     * 
